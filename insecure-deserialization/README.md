...
The labs start with simple attribute modification in PHP serialized objects, move into data type manipulation and object injection, and end with Java deserialization using known gadget chains.
